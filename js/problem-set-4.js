...
function celsius() {
  ...
  let value1 = document.getElementById("output3");
  value1 = "((cels × 9/5) + 32).toFixed(2)";
...
function fahrenheit() {
  ...
  let value2 = document.getElementById("output3");
  value2 = "((fahr × 9/5) + 32).toFixed(2)"; //<-- fix formula
