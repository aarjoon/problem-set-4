...
function hello() {
  ...
  let ex1 = document.getElementById("output1");
...
function helloAgain() {
  ...
  let greeting = document.getElementById("output2");
...
function fluidOunces() {
  ...
  let fluidOunces2 = Math.floor((fluidOunces) % 8);
...
function ounces() {
  ...
  let ounces2 = Math.floor((ounces) % 16);
...
function money() {
  ...
  let pennies2 = Math.floor((pennies - (dollars*100) - (quarters*25) - (dimes*10) - (nickels*5))/1);
...
function change() {
  ...
  let pennies = Math.floor(amount);
  amount = (amount-(pennies*100));
  let change = (quarters+dimes+nickels+pennies);

  if(change==1) {
   document.getElementById("output10").innerHTML = change + " coin.";
 } else {
